 ...
 */
final class Version20220313082044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE soignant (id INT AUTO_INCREMENT NOT NULL, soignant_nom VARCHAR(255) NOT NULL, soignant_prenom VARCHAR(255) NOT NULL, soignant_initial VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
