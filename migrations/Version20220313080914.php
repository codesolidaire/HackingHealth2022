 ...
 */
final class Version20220313080914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE territoire (id INT AUTO_INCREMENT NOT NULL, territoire_libelle VARCHAR(255) NOT NULL, territoire_cp INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
